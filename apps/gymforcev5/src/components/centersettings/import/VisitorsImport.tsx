...
export default function VisitorImport() {
    ...
    if (file) {
      ...
      try {
        ...
        const response = await AxiosPrivate.post(
          `/api/data_import/visitordata/?gym_id=${gym_id}`,
          {
            file:file,
  ...
  const handleTemplateDownload = () => {
    ...
    link.href = 'https://docs.google.com/spreadsheets/d/1RMOSXOV6i-fHc-ZZZyRVct3Fj8rWetvA/export?format=xlsx';
    link.download = 'template-visitors.xlsx';
    link.click();
  };
  ...
  return (
    <div className="mt-3">
     <div className='flex flex-col items-center gap-3'>
      <Title as='h3'>Visitor Import</Title>
      <p className="mb-8">Easily migrate your existing visitor data into our platform.</p>
      </div>
      <div className="mb-6">
