...
export default function PackageImport() {
    ...
    if (file) {
      ...
      try {
        ...
        const response = await AxiosPrivate.post(
          `/api/data_import/packagedata/?gym_id=${gym_id}`,
          {
            file:file,
  ...
  const handleTemplateDownload = () => {
    ...
    link.href = 'https://docs.google.com/spreadsheets/d/1IehLHnEg0MrNdwdSqOGLsvOeqMM9gB5W/export?format=xlsx';
    link.download = 'template-package.xlsx';
    link.click();
  };
  ...
  return (
    <div className="">
      ...
      <Title as='h3'>Package Import</Title>
      <p className="mb-8">Easily migrate your existing package data into our platform.</p>
      </div>
      <div className="mb-6">
