...
export default function GymDataImport() {
  ...
  const handleTemplateDownload = () => {
    ...
    link.href =
      "https://docs.google.com/spreadsheets/d/1IehLHnEg0MrNdwdSqOGLsvOeqMM9gB5W/export?format=xlsx";
    link.download = "template-members.xlsx";
    link.click();
  };
  ...
  return (
    <div className="w-full p-4">
      <div className="flex flex-col items-center gap-3">
        <Title as="h3">GymData Import</Title>
        <p className="mb-8">
          Easily migrate your existing center settings data into our platform.
        </p>
      </div>
