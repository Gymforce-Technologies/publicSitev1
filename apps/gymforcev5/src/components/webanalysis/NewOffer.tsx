...
interface FormDataType {
  ...
  preview: string | null;
  package_id: number;
  offer_price: string; // Add this line
}
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formDataToSend.append(
        "offer_startDate",
        formateDateValue(new Date(formData.offer_startDate), "YYYY-MM-DD")
      );
      formDataToSend.append(
        "offer_endDate",
        formateDateValue(new Date(formData.offer_endDate), "YYYY-MM-DD")
      );
      formDataToSend.append("offer_price", formData.offer_price.toString()); // Add this line
