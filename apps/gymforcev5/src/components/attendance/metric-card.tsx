...
const metricCardClasses = {
  base: 'border border-muted bg-gray-0 p-5 lg:p-6',
  rounded: {
    sm: 'rounded-sm',
    DEFAULT: 'rounded-lg',
    lg: 'rounded-xl',
      ...
      <div className="flex items-center justify-center ">
        <div className="flex items-center">
          {icon ? (
            <div
              className={cn(
                'flex h-15 w-15 items-center justify-center rounded-lg bg-gray-100 lg:h-12 lg:w-12',
                iconClassName
              )}
            >
              {icon}
          ...
          <Text className={cn('mb-0.5 text-gray-900 ', titleClassName)}>
              {title}
            </Text>
          <Text
              className={cn(
                `font-lexend text-lg font-semibold 2xl:xl:text-xl flex justify-center items-center  `,
                metricClassName
              )}
            >
