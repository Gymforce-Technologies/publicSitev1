...
import { FaCalendar, FaIndianRupeeSign, FaUser } from "react-icons/fa6";
...
export default function Add({
  ...
  const handleCreateTemplate = async (e: React.FormEvent): Promise<void> => {
    ...
    try {
      ...
      console.log({ ...newTemplate, content: transformedContent });
      const gymId = await getGymId();
      await AxiosPrivate.post(`/api/wa-templates/?gym_id=${gymId}`, {
    ...
    >
      <div className="flex flex-col gap-4 p-6 md:p-8 ">
        ...
        <Textarea
          ...
          labelClassName=""
        />
        <Button onClick={handleCreateTemplate} className="max-w-xs self-center">
