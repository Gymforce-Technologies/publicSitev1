...
const AddShiftModal = ({ isOpen, onClose, onSuccess }: AddShiftModalProps) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      await AxiosPrivate.post(`/api/shifts/create/?gym_id=${gymId}`, {
      ...
      toast.error(error.response?.data?.message || "Something went wrong while creating shift");
    }
  };
