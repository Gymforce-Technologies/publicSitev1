...
// import { getColumns } from "../../../../components/gallery/columns";
// // import { expensesData } from "@/data/Expenses-data";
// import WidgetCard from "@/components/cards/widget-card";
// import { useCallback, useState, useMemo } from "react";
// import { useTable } from "@core/hooks/use-table";
// import { useColumn } from "@core/hooks/use-column";
// import ControlledTable from "../../../../components/gallery";
...
//     }
//   };
//   const { visibleColumns  } = useColumn(columns);// columnsData
//   return (
//     <div className="flex flex-col gap-3">
//       <Title as="h3">Upload Gallery Image</Title>
//       <div className="flex flex-col gap-3">
//       <WidgetCard
...
//           <button
//             className={
//               "bg-white  text-black rounded-md hover:bg-opacity-70 p-3"
//             }
//             onClick={() => {
//               setIsOpen(true);
//             }}
...
//     >
//       <div>
//         <Title as='h5'>Gallery List</Title>
//       </div>
//       <ControlledTable
//         variant="modern"
//         data={expenses}
...
//         // @ts-ignore
//         columns={visibleColumns} //columnsData
//         paginatorOptions={{
//           pageSize,
//           setPageSize,
//           total: dataCount,
...
//           <div className="bg-[#111111] text-white p-6 rounded-md shadow-md">
//             <p>Are you sure you want to delete this expense?</p>
//             <div className="mt-4 flex justify-end gap-2">
//               <button
//                 className="bg-white text-[#111111] p-2 rounded-md hover:bg-red-600"
//                 onClick={() => handleDeleteItem(deleteConfirm)}
//               >
//                 Yes
//               </button>
//               <button
//                 className="bg-gray-300 text-[#111111] p-2 rounded-md hover:bg-gray-400"
