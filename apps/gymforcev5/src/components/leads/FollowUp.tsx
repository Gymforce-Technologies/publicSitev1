...
export const AddLeadFollowup: React.FC<AddLeadFollowupProps> = ({
  leadId,
  refresh,
  modelState,
  setModelState,
    ...
    const fetchPrerequisites = async () => {
      try {
        ...
        const response = await AxiosPrivate.get(
          ...
          {
            id: newID(`lead-followup-prerequities`),
          }
        );
        // setPurposes([
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Lead Followup added successfully");
      invalidateAll();
      resetForm();
      refresh();
    } catch (error) {
      console.error("Failed to add lead followup:", error);
      toast.error("Something went wrong while adding lead followup");
    } finally {
