export default function Loader(){
    return(
        <section className="p-10 lg:px-16">
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2 xl:mt-12 xl:gap-12">
            <div role="status" className="animate-pulse rounded border border-gray-300 p-4 shadow md:p-6 dark:border-gray-600">
            ...
            <div role="status" className="animate-pulse space-y-4 divide-y divide-gray-300 rounded border border-gray-300 p-4 shadow md:p-6 dark:divide-gray-600 dark:border-gray-600">
